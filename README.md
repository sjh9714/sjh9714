...
- **하나금융그룹 x 금융감독원 청년 금융인재 양성 프로젝트** | 아이디어 경진대회로 선발된 13개 팀 54명 · 금융데이터 분석 · 생성형 AI · LLM · 금융소비자 보호와 ESG (2026.04 ~ 2026.08)
- **Tech4Good 해커톤** | 하나금융그룹 x SK텔레콤 `SKT FLY AI` 연합 · 주제 "포용적 미래를 위한 AI 서비스" (2026.07)
